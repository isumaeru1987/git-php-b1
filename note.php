...
<head>
  ...
  <title><?= $test['nom']; ?> <?= $test['prenom']; ?></title>
</head>
<body>
  <div class="page">
    <section class="student-card">
      <div class="student-photo">
        <img src="assets/images/students/<?= $test["image"] ?>" alt="Photo de <?= $eleve["nom"]; ?> <?= $eleve["prenom"]; ?>">
      </div>

      <div class="student-info">
        <h1><?= $test["nom"]; ?> <?= $test["prenom"]; ?></h1>
      <div class="student-class"><?= $test["classe"]; ?></div>
