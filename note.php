...
<head>
  ...
  <title><?= $eleve[$firstKey]["nom"].' '. $eleve[$firstKey]["prenom"]?></title>
</head>
<body>
  <div class="page">
    <section class="student-card">
      <div class="student-photo">
        <img src="assets/images/students/<?=$eleve[$firstKey]["image"]?>" alt="Photo de <?= $eleve[$firstKey]["nom"].' '. $eleve[$firstKey]["prenom"]?>">
      </div>

      <div class="student-info">
        <h1><?= $eleve[$firstKey]["nom"].' '. $eleve[$firstKey]["prenom"]?></h1>
        <div class="student-class"><?= $eleve[$firstKey]["classe"] ?></div>
