...
| Boucle des élèves | 1/1.5 |
==> problème de fermeture de boucle, pas au bon endroit
...
| Boucle matières + notes | 0.5/2 |
| Moyennes (matière + générale) | 1/4 |
==> je te laisse regarder ma branche pour un exemple de correction
